#!/usr/bin/env python3
"""
narrow_u_world_launch.py
=========================
Dar Koridor U-Donus dunyasini Gazebo'da baslatir ve robotu spawn eder.

Spawn pozisyonu: (-2.5, +2.6, yaw=0.0)
World          : narrow_u_world.world

Kullanim:
  Terminal 1: ros2 launch my_config narrow_u_world_launch.py
  Terminal 2: ros2 launch my_config <algo>_narrow_u_launch.py
"""
import os
