...
def generate_launch_description():
    ...
    yaw_pose     = LaunchConfiguration('yaw_pose',     default='1.5708')  # 90° — kuzey
    ...
    # ── World file — dynamic_world.world ─────────────────────────────────────
    world = os.path.join(
        get_package_share_directory('my_config'),
        'worlds',
        'dynamic_world.world'   # ← static_world.world'dan tek fark bu satır
    )
    ...
    # ── 4. Spawn robot (6 sn gecikmeli — Gazebo'nun tam yüklenmesi için) ──────
    # Dynamic world aktörler simülasyon başlar başlamaz hareket etmeye başlar.
    # 6 saniyelik gecikme, aktörlerin ilk pozisyonlarına yerleşmesini sağlar.
