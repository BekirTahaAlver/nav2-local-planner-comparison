#!/usr/bin/env python3
"""
narrow_z_world_launch.py
=========================
Dar Koridor Z-Donus dunyasini Gazebo'da baslatir ve robotu spawn eder.

Spawn pozisyonu: (-2.5, +2.6, yaw=0.0)
World          : narrow_z_world.world

Kullanim:
  Terminal 1: ros2 launch my_config narrow_z_world_launch.py
  Terminal 2: ros2 launch my_config <algo>_narrow_z_launch.py
"""
import os
...
def generate_launch_description():
    ...
    yaw_pose     = LaunchConfiguration('yaw_pose',     default='0.0')   # doguya bakar
    ...
    # ── 0. Onceki session kalintisini temizle ─────────────────────────────────
    ...
    # ── 4. Spawn — spawn_entity.py ile yaw destegi ────────────────────────────
